...
export default function Form(){
  ...
  // const [user,setUser] = useState(gt.id)
  ...
  // JSON.stringify({ id,title,price,desc }) 
    // console.log(
    //   `Id: ${id}`,
    //   `Title:${title}`,
    //   `Price:${price}`,
  ...
  return (
    <div className="... flex flex-row content-between justify-center py-6">
      <div className="formContainer w-96  justify-center rounded-lg border bg-gray-200 px-2 py-2">
        ...
        >
          <div className="grid gap-2">
            ...
            <input
              className="w-80 rounded-lg border px-2 py-2 outline-none"
              type="text"
              name="categoryId"
              value={categoryId}
              ...
              autoComplete="off"
            />
            <p className="text-l px-2 pb-6 text-gray-500">
